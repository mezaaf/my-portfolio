...
const HeroSection = () => {
  return (
    <>
      <SectionContainer
        id="home"
        className="z-1 bg-gradient-to-tr from-sky-50 via-white to-sky-100 py-8 sm:py-12 lg:py-16 lg:pb-0 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900"
      >
          ...
          <div className="flex w-full max-w-3xl flex-col space-y-4 sm:space-y-6 lg:space-y-8 lg:py-24">
            ...
            <div className="flex flex-col sm:gap-2 lg:gap-3">
              ...
              <p className="text-center text-base sm:text-lg lg:text-start lg:text-xl">
                I&apos;m a fullstack developer from Madiun, ID, ready to help
                you build complete web solutions — beautiful on the front,
